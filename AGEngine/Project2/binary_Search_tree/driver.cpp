...
//}
//
////void create_int_int_random_map( CS280::BSTmap<int,int> & map, int N, int resize, bool shuffle )
////{
...
//}
//
//// inserts/deletes/finds
//void test7() {
//    inserts_delete_random( 1000, 10, 2, 100, 0.5, true );
//}
//
//////////////////////////////////////////////////
...
//
//// should run in less than 0.2 seconds, if it is taking 1 second or more 
//// you may have inefficient algorithms
//// double check that find and insert and delete are log N
//void test14() {
//    inserts_delete_random( 20000, 100, 20, 200, 0.5, true );
//}
//
//// random inserts and deletes (no finds) - stress test
//// 1000 times: insert up to 100 and delete 10%
//// max size 1000*100=100000
//// expected: no crashes and takes several seconds
//void test15() {
//    inserts_delete_random( 100000, 1000, 50, 100, 0.1, false ); // delete 10%
//}
//
//// random inserts and deletes (no finds) - stress test
//// 1000 times: insert up to 100 and delete 90%
//// max size 1000*100=100000
//// expected: no crashes and takes several seconds
//void test16() {
//    inserts_delete_random( 100000, 1000, 50, 100, 0.9, false ); // delete 90%
//}
//
//// stress test copy - should be linear
//void test17() {
//    int N = 20000;
//    CS280::BSTmap<int,int> map;
//    std::vector<int> data( N );   // data to insert
...
//
//    for ( int i=0; i<100; ++i ) {
//        CS280::BSTmap<int,int> map2( map ); // copy
//        for ( int j=N/2 -20; j<N/2 +20; ++j ) {
//            if ( map2.find( j ) == map2.end() ) {
//                std::cout << "Error - not found in copy\n";
//            }
//        }
//    }
//}
//
//// stress test assignment - should be linear
//void test18() {
//    int N = 20000;
//    CS280::BSTmap<int,int> map;
//    std::vector<int> data( N );   // data to insert
...
//
//    for ( int i=0; i<30; ++i ) {
//        CS280::BSTmap<int,int> map2; // empty
//        std::vector<int> data2( N );   // data to insert
//        std::iota( data2.begin(), data2.end(), 1 );
//        std::shuffle( data2.begin(), data2.end(), std::mt19937{std::random_device{}()} );
//        // insert N elements
...
//
//#include <chrono>
//// stress test move copy - extra credit, should be constant
//void test19() {
//    int N = 200000;
//
//    // original tree
...
//
//    // measure move copy time 
//    start = std::chrono::system_clock::now();
//    CS280::BSTmap<int,int> map3( std::move( map ) );
//    stop = std::chrono::system_clock::now();
//    std::chrono::duration<double> move_assign_elapsed_seconds = stop-start;
//
//    if ( move_assign_elapsed_seconds.count() < 0.0001*deep_assign_elapsed_seconds.count() ) {
//        std::cout << "Move copy may be implemented\n";
//    } else {
//        std::cout << "Move copy is NOT implemented\n";
//    }
//    //std::cout << move_assign_elapsed_seconds.count()/ deep_assign_elapsed_seconds.count() << "\n";
//
//    // test correctness of move assignment 
//    for ( int const& key : data ) {
//        if ( map3.find( key ) == map3.end() ) {
//            std::cout << "Not found in a move copied\n";
//        }
//    }
//}
//
...
//    std::shuffle( data3.begin(), data3.end(), std::mt19937{std::random_device{}()} );
//    // insert N elements
